...
class TDSKnowledgeBase:
    ...
    def scrape_discourse_forum(self):
        ...
        try:
            # Discourse API endpoint for TDS category
            ...
            if response.status_code == 200:
                ...
                for topic in topics[:20]:  # Limit to recent topics
    ...
    def find_relevant_content(self, question):
        ...
        # Check for specific keywords and return relevant links
        ...
        # Always include main discourse category
...
def trigger_scrape():
    """Trigger data scraping from TDS website and Discourse"""
    try:
